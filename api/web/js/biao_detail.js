    ...
    function comptime() {
        $.ajax({
            ...
            success: function (data) {
                ...
                setTitle("#pi_common_header", {'title': '枯枯枯'});
                $('#pi_common_header').find('span').text(_title);


                str_rates = '<p>预期年化率</p><p><span>5.6</span><span>%</span></p>';
                ...
                //   起投金额 锁定期
                    str_start_money = '<li><p>起投金额</p><p>1000元</p></li><li></li><li class="lock_time"><p>锁定期</p><p>6个月</p></li>';
                ...
                //  认证级别 项目介绍
                if (data.EU_RATINGS != '') {
                    identification_level = 'AAA级认证保障';
                } else {
                    identification_level = '';
                }

                str_identification_level = '<tr onclick=' + 'window.location.href="production_introduce.html"><td class="bottom_border"><i class="pi_icon pi_icon_intro"></i><span class="font_bold">项目介绍</span></td><td class="bottom_border" style="text-align: right;font-size: 0.26rem;color: #c1c1c1;">' + identification_level + '<img src="../img/zhankai.png"></td></tr>';
                ...
                str_bo_invest_num = '<tr onclick=' + 'window.location.href="invest_record.html?id=' + bo_number + '"><td class="bottom_border"><i class="pi_icon pi_icon_invest"></i><span class="font_bold">投资记录</span></td><td class="bottom_border" style="text-align: right;font-size: 0.26rem;color: #c1c1c1;">' + recordStr + '<img src="../img/zhankai.png"></td></tr>';
